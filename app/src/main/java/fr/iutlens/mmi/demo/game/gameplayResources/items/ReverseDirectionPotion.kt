...
class ReverseDirectionPotion() : Item(
    ...
    effects = {
        game ->  game.controllableCharacter!!.dragMovingBehavior = {
            x, y ->
        ...
        game.controllableCharacter!!.tapMovingBehavior = {
                x, y ->
            val xDifference : Float = abs(x - game.controllableCharacter!!.sprite.x)
            val yDifference : Float = abs(y - game.controllableCharacter!!.sprite.y)
            val xVal = when{
            ...
            game.controllableCharacter!!.findShortestPath(game.controllableCharacter!!.sprite.x + xVal, game.controllableCharacter!!.sprite.y + yVal)
        }
    }
) {
}